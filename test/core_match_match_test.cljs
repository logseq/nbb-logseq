...
;; Copied from https://github.com/clojure/core.match/blob/master/src/test/cljs/core/match/tests.cljs
;; and modified to only run match tests and to run in a nbb env.
;; All code that isn't run was commented out.
;; There 9 TODOs that fail tests at runtime, almost all because cljs.core/ILookup doesn't exist in sci
(ns core-match-match-test
  #_(:require-macros
